...
// Arquivo: login.php
session_start();
require_once 'config.php'; // Carrega configurações de DB
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        // Conexão específica com o banco de usuários do sistema
        $dsn = "mysql:host=" . DB_HOST . ";dbname=netmaxxi_callcenter;charset=utf8";
        ...
        if ($data && password_verify($pass, $data['password'])) {
            ...
            $_SESSION['user_tech'] = $data['tech'] ?? 'PJSIP';

            // REDIRECIONAMENTO: Vai para o Dashboard Principal
            header('Location: dashboard_direto.php');
            exit;
        } else {
        ...
        <div class="card">
            ...
            <form method="POST">
                ...
                <button type="submit" class="btn btn-primary w-100 btn-login">
                    ENTRAR NO SISTEMA <i class="bi bi-arrow-right-short ms-1" style="font-size: 1.2rem; vertical-align: middle;"></i>
                </button>
            </form>
